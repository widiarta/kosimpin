...
<body>
    ...
    <table>
	<tr><td>Untuk Pinjaman</td><td>:</td><td><?php echo date("d-M-y",strtotime($pinjaman[0]->tgl_transaksi));?></td></tr>
	<tr><td>Saldo Hutang</td><td>:</td><td><?php echo number_format($pinjaman[0]->saldo,0); ?></td></tr>
	</table>
	<br/>
